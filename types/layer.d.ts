import { BoxSize, Delta, LayerComponentProps, LayerId, LayerType } from '@lidojs/design-core';
...
export type LayerDataRef = Record<LayerId, Pick<LayerComponentProps, 'position' | 'boxSize' | 'rotate' | 'scale'> & {
    centerX?: number;
    centerY?: number;
    type: LayerType;
}>;
